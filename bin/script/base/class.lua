...
gm.__index = function(g, key)
	local c = classes[key]
	if c == nil then
		error("you can't __index global variable(for right value): xxx="..tostring(key)..", "..debug_traceback())
	end
	return c
end
...
gm.__newindex = function(g, key, value)
	...
	error("you can't __newindex global variable(for left value): "..tostring(key).."="..tostring(value)..", "..debug_traceback())
end
setmetatable(_G, gm)
